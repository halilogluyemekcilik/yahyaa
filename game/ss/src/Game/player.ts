...
export default class Player extends EventEmitter {
    // Oyuncu modeli, animasyonları ve kamera/ışık etkileşimleri
    ...
    // Oyuncuyu oluştur ve animasyon/materyal ayarlarını yap
    async createPlayer(first: boolean = true) {
        ...
        // Animasyon kliplerini isimlerine göre hazırlayıp hız/loop ayarlarını yap
        for (const animate of animations) {
            ...
            if (actionName === playerStatus.FALL) {
                ...
                action = this.mixer.clipAction(actionClip);
                action.loop = THREE.LoopOnce;
                // Yere düşme yavaş oynatılır
                // action.clampWhenFinished = true; // istenirse son karede dondur
            ...
            if (actionName === playerStatus.DIE) {
                ...
                // Son karede dur
                action.clampWhenFinished = true;
                // action.timeScale = 0.2; // istenirse daha yavaş
            }
        ...
        // Gölgeleri performans için kapat
        ...
        // Girdi/çarpışma ve animasyon kontrolü
    ...
    // Oyuncuyu takip eden kamera güncellemesi
